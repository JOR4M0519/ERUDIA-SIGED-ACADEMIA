...
public interface PersistanceActivityGradePort extends PersistencePort<ActivityGradeDomain, Integer> {
    ActivityGradeDomain getGradeByActivityId(Integer id, ActivityGradeDomain activityGradeDomain);

    List<ActivityGradeDomain> gradeActivity(List<ActivityGradeDomain> activityGradeDomain);
}
